...
./fmcheck reboot-controller c1 -t fm-topo.yml
./fmcheck reboot-controller-by-switch n100 -t fm-topo.yml
...
./fmcheck get-flow-node-stats-all <node> -t fm-topo.yml
./fmcheck get-flow-node-stats <node> 0 -t fm-topo.yml
./fmcheck get-group-stats-all -t fm-topo.yml
./fmcheck get-group-stats 0 -t fm-topo.yml
./fmcheck get-group-node-stats-all <node> -t fm-topo.yml
./fmcheck get-group-node-stats <node> 0 -t fm-topo.yml
